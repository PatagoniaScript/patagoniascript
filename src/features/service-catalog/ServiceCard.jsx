...
export const ServiceCard = ({
  ...
  return (
    <div
      className="absolute top-1/2 left-1/2 cursor-pointer h-[540px] sm:h-[570px]"
      style={{
        ...style,
    ...
    >
      ...
      <div
        className={`
          ...
          rounded-xl shadow-2xl transition-all duration-700 flex flex-col overflow-hidden p-5 sm:p-8
