...
export const ContactForm = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 z-10 relative flex justify-center items-center">
      <form
        onSubmit={handleSubmit}
        className="flex-1 w-full max-w-md bg-gradient-to-br from-patagonia-petrol/40 to-patagonia-darkest/40 backdrop-blur-xl border border-patagonia-turquoise/40 rounded-2xl p-8 shadow-2xl text-white"
      >
        {/* Name */}
        <div className="mb-7">
